...
class TestConvertToMountebank(unittest.TestCase):
    ...
    def test_to_stub_includes_header_predicate(self):
        ...
        self.assertTrue(any('equals' in p and 'headers' in p.get('equals', {}) or ('headers' in p and isinstance(p.get('headers'), dict)) for p in preds))
    ...
    def test_non_strict_body_omits_body_predicate_for_nonjson(self):
        ...
        self.assertFalse(any('equals' in p and 'body' in p.get('equals', {}) for p in preds))
